...
public class CompanyTest {
	public static void main(String[] args) throws IOException {
		...
		all.add("【10000亿——阿里巴巴称淘宝和天猫本年度的总零售额突破 10000 亿】 阿里巴巴还公布了其它有趣的数据：2012 年第 3 季度中国第三方互联网支付市场交易规模达到 9764 亿元人民币，支付宝占 46.9%，财付通占 20.4%，银联在线占 11.5%") ;
		for (String string : all) {
			List<Term> paser = NlpAnalysis.paser(string);
