...
* 1.补充文档,增加调用实例和说明
* 2.将项目提交到maven中央仓库
* 3.增加一些规则性Recognition，举例[https://github.com/NLPchina/ansj_seg/blob/master/src/main/java/org/ansj/recognition/impl/IDCardRecognition.java](身份证号码识别)，目前未完成的有 `时间识别`，`IP地址识别`，`邮箱识别`,`网址识别`等...
