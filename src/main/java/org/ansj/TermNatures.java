...
import static org.ansj.NumNatureAttr.NULL_NUM_NATURE_ATTR;
...
//    public static final TermNatures NT = new TermNatures(TermNature.NT);
     ...
     * 关于这个term的所有词性
     */
    public final List<TermNature> termNatures;
    /**
     * 所有的词频
     */
    ...
    private TermNatures(
            final int id,
            final List<TermNature> termNatures,
            final int allFreq,
            final Nature nature,
        ...
        this.id = id;
        this.termNatures = ImmutableList.copyOf(termNatures);
